...
export default function App() {
  return (
    <div className="crt flex min-h-screen bg-[#0b0b12] text-gray-100 relative overflow-hidden">
      ...
      {/* RIGHT SIDE ART VAULT */}
      <RightSkillsProgress />

      {/* MAIN CONTENT */}
      <main className="relative z-10 flex-1 max-w-7xl mx-auto p-6 pt-24 md:pt-12 md:p-12 space-y-24 lg:pr-72">
